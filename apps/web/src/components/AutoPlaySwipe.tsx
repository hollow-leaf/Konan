                ...
                <Box className="flex flex-col justify-center items-center">
                    ...
                    >
                        ...
                        <Box className="flex flex-col items-center justify-center">
                            <Typography className="text-2xl font-bold text-black">{images[index].label}</Typography>
                            <Typography className="text-2xl font-bold text-black">{images[index].title}</Typography>
                            ...
                            <Box key={index} className="rounded-3xl justify-center items-center flex flex-col">
                                <Box className="flex flex-col xl:flex-row gap-10">
                                    ...
                                    <Box className="flex flex-col justify-center">
                                        <Typography className="text-4xl xl:text-8xl font-bold">{image.label}</Typography>
                                        <Typography className="text-2xl xl:text-4xl font-bold">{image.title}</Typography>
                                        <Link href={`${image.linkedin}`} className="xl:mt-72" target='_blank'>
